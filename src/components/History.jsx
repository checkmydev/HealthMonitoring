          ...
          <tbody>
            {entries.map((e) => (
              <tr key={e.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                ...
                <td className="py-2 pr-3"><Badge value={e.sleepQuality} invertColor={false} /></td>
                <td className="py-2 pr-3"><Badge value={e.fatigue} invertColor={true} /></td>
                <td className="py-2 pr-3"><Badge value={e.stress} invertColor={true} /></td>
                <td className="py-2 pr-3"><Badge value={e.mood} invertColor={false} /></td>
                <td className="py-2 pr-3"><Badge value={e.energy} invertColor={false} /></td>
